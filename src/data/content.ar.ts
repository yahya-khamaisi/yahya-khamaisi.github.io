...
const projects: Project[] = [
  ...
  },
  {
    ...
    role: 'مطوّر مستقل',
    period: '2024',
    blurb: 'كتالوج منتجات سريع وقابل للتصفية مع بحث وترتيب وحالات تحميل هيكلية.',
    overview:
      'FilterKit واجهة كتالوج صغيرة بـ React وTypeScript بُنيت لاستكشاف التصفية السريعة من جانب العميل — بحث، تصفية حسب الفئة، ترتيب، عدّاد نتائج مباشر، وحالات تحميل هيكلية، بتنسيق Tailwind CSS.',
    details: [
      'بحث وتصفية حسب الفئة وترتيب عبر كتالوج منتجات.',
      'حالة تحميل هيكلية ومعالجة نتائج فارغة.',
      'تخطيط Tailwind CSS مع بطاقات منتجات متجاوبة.',
    ],
    impact: ['نمط تصفية قابل لإعادة الاستخدام منشور كتنفيذ مرجعي نظيف.'],
  ...
  },
  {
    ...
    tag: 'GitHub · قالب Next.js',
    role: 'مطوّر مستقل',
    period: '2024',
    blurb: 'قالب بداية شخصي محدَّد الرأي على Next.js 16 وReact 19 وTypeScript وTailwind CSS 4.',
    overview:
      'خط أساس نظيف لمشاريع جديدة — اتفاقيات Next.js App Router الحديثة، وTailwind CSS 4، وTypeScript جاهزة من البداية بحيث يتجاوز العمل الجديد الأعمال التمهيدية المتكررة.',
    details: [
      'Next.js 16 App Router مع React 19 وTypeScript.',
      'Tailwind CSS 4 وتهيئة ESLint مسطّحة جاهزة.',
      'صفحة هبوط بهوية مخصصة تحل محل قالب create-next-app الافتراضي.',
    ],
    impact: ['نقطة انطلاق قابلة لإعادة الاستخدام لمشاريع شخصية وعميلة جديدة.'],
  ...
  },
  {
    slug: 'polar-6g-sim',
    title: 'Polar 6G Sim',
    tag: 'GitHub · محاكاة 6G',
    role: 'مطوّر مستقل',
    period: '2024',
    blurb: 'محاكاة رابط 6G بترميز قطبي عبر نماذج قنوات AWGN وIRS وTHz وIAB وURLLC وMassive MIMO وNOMA.',
    overview:
      'محاكاة مستقلة تستكشف أداء الترميز القطبي عبر عدة نماذج قنوات 6G — تقطيع الشبكة، وتخصيص الموارد، والتنقّل، وتقييم معدل الخطأ، بمعزل عن منصة بحث الدكتوراه.',
    details: [
      'ثمانية نماذج قنوات مُقارَنة تحت خط أنابيب ترميز قطبي مشترك.',
      'تأثيرات تقطيع الشبكة وتخصيص الموارد والتنقّل مُطبَّقة على الإرسال.',
      'عمليات مسح BER مقابل SNR تُعرَض كجداول ورسوم عبر واجهة سطر أوامر.',
    ],
    impact: ['مرجع عام وقابل للتشغيل لمقارنة نماذج قنوات 6G جنباً إلى جنب.'],
  ...
  },
  {
    ...
    role: 'مطوّر مستقل',
    period: '2020',
    blurb: 'واجهة برمجية للطقس على Azure Functions مدعومة بـ OpenWeatherMap، مع واجهة أمامية ثابتة.',
    overview:
      'يجمع SkyCast بين واجهة برمجية بلا خادم على Azure Functions وواجهة أمامية ثابتة صغيرة — يجلب بيانات التنبؤ الحية ويعرضها عبر واجهة عميل نظيفة، بُني لممارسة استهلاك واجهات الطرف الثالث دون تضمين المفاتيح السرية في الكود المصدري.',
    details: [
      'واجهة Azure Functions (Node.js) مدعومة بواجهة OpenWeatherMap.',
      'مفتاح الواجهة البرمجية يُقرأ من متغيرات البيئة، ولا يُرفَع أبداً.',
      'واجهة أمامية ثابتة تستدعي نقطة نهاية الدالة مباشرة.',
    ],
    impact: ['تكامل واجهة برمجية بلا خادم كامل وعامل شُحن من الصفر.'],
...
const publications: Publication[] = [
  {
    ...
    icon: 'chip',
    note: 'نهج كشف قائم على YOLOv8 مُطبَّق على تحليل لقطات كاميرات المراقبة.',
  },
  {
    title:
