...
const pageMeta: Site['pageMeta'] = {
  ...
  '/about': {
    title: 'نبذة — يحيى خمايسة',
    description:
      'تسليم إنتاجي وبحث دكتوراه يُمارَسان كممارسة واحدة — أنظمة مبنية لتصمد، ودراسة متواصلة لما يجعلها موثوقة.',
  },
  '/projects': {
  ...
  '/experience': {
    title: 'الخبرة — يحيى خمايسة',
    description:
      'ست سنوات عبر خمسة أدوار — تسليم ذكاء اصطناعي وسحابة وواجهات برمجية في الإمارات وسنغافورة وماليزيا، وحالياً إدارة محفظة ذكاء اصطناعي للتأمين في Takaful Emarat.',
  },
  '/education': {
    title: 'التعليم — يحيى خمايسة',
    description:
      'دكتوراه في الحوسبة تركز على الذكاء الاصطناعي التطبيقي، وماجستير في علوم الحاسوب، وبكالوريوس في هندسة الحاسوب — الأول على القسم مرتين.',
  },
  '/skills': {
    title: 'المهارات — يحيى خمايسة',
    description:
      'الخوادم والواجهات البرمجية، الذكاء الاصطناعي والاسترجاع، البيانات والسحابة، الـ full stack والمنتج — كل مجال مرتبط بمشروع طُبّق فيه.',
  },
  '/research': {
    title: 'البحث والمنشورات — يحيى خمايسة',
    description:
      'بحث دكتوراه في موثوقية مصانع 6G الذكية وإدارة الموارد بمساعدة الذكاء الاصطناعي، مع أعمال منشورة حول URLLC والرؤية الحاسوبية وأمن VoIP وأخلاقيات الذكاء الاصطناعي.',
  },
  '/contact': {
    title: 'تواصل — يحيى خمايسة',
    description:
      'الاستفسارات حول الـ full-stack وهندسة الذكاء الاصطناعي والتعاون البحثي مُرحّب بها. مقيم في دبي، الإمارات؛ العمل عن بُعد متاح.',
  },
}
...
const aboutStats: Site['aboutStats'] = [
  { label: '6 سنوات', detail: 'تسليم إنتاجي عبر ثلاث دول', icon: 'years' },
  { label: 'الذكاء الاصطناعي أولاً', detail: 'وكلاء وRAG وتقييم في منتجات حقيقية', icon: 'ai' },
  { label: 'مدعوم بالدكتوراه', detail: 'بحث دكتوراه في الذكاء الاصطناعي التطبيقي، جارٍ', icon: 'research' },
  { label: 'الأول على القسم', detail: 'الأول على الدفعة، بكالوريوس وماجستير', icon: 'education' },
]
...
const aboutEssay: AboutEssay = {
  kicker: 'نبذة',
  title: 'كيف يُنجَز العمل',
  lede:
    'العمل الأساسي هو هندسة full-stack لمنتجات الذكاء الاصطناعي — وكلاء، استرجاع، واجهات برمجية، والسحابة التي تشغّلها. يسير إلى جانبه مسار بحث دكتوراه، حيث يُدرَس السؤال نفسه بتأنٍّ أكبر: ما الذي يجعل النظام موثوقاً فعلاً تحت الحِمل.',
  sections: [
    {
      id: 'who',
      title: 'الممارسة',
      paragraphs: [
        'تُبنى الواجهات البرمجية والخدمات السحابية والبوابات الإدارية وأنظمة الذكاء الاصطناعي الوكيلية لعملاء مؤسسيين يومياً. يُعامَل الذكاء الاصطناعي كسطح منتج بالصرامة نفسها لأي سطح آخر: تُتحقَّق المدخلات، ويُقيَّم السلوك، وتُعالَج حالات الفشل بدل تمنّي غيابها.',
        'يُتابَع أيضاً دكتوراه في الحوسبة بدوام جزئي، بتركيز على الذكاء الاصطناعي التطبيقي وتعلّم الآلة للأنظمة الشبكية الموثوقة. ليست مهنة ثانية تنافس على الاهتمام — بل حيث يُفكَّر في الموثوقية تحت الضغط دون موعد تسليم نهائي، وتُنقَل تلك الاستنتاجات إلى العمل الهندسي.',
      ],
    },
    {
      id: 'career',
      title: 'ما تم تسليمه',
      paragraphs: [
        'في القطاع، قُدتُ أو ساهمتُ في منصة تجديد تأمين وكيلية لـ Takaful Emarat، وأنظمة قسائم طيران لـ Malaysia Airlines، ومنصات استرجاع وبحث متعدد المستأجرين لـ CoolRIOTS، ووسيط Azure للمحتوى السياحي، وبوابات عمليات المطالبات. يُطبَّق الحدس نفسه في كل مكان: تُرسَم حدود الخدمات بوضوح، وتُتحقَّق المدخلات بصرامة، وتُجعَل ميزات الذكاء الاصطناعي قابلة للقياس لا سحرية.',
        'الجانب البحثي هو Factory6G — منصة Docker-first تُختبَر فيها الجدولة والموثوقية بمساعدة الذكاء الاصطناعي تحت حِمل مُحاكى، ومصدر أعمال منشورة في الذكاء الاصطناعي التطبيقي والرؤية الحاسوبية وأمن الأنظمة. تُغذّي الهندسة؛ وليست العنوان.',
        'مجتمعةً، يُحفَظ نمط واحد: تُفضَّل بيئات التشغيل السحابية الأصلية، ويُعامَل التحقق كغير قابل للتفاوض، ويُتوقَّع من الذكاء الاصطناعي أن ينجو من ملامسة البيانات الحقيقية، ويُوثَّق العمل بوضوح كافٍ ليلتقطه شخص آخر.',
      ],
    },
    {
      id: 'place',
      title: 'مقيم في دبي',
      paragraphs: [
        'دبي، الإمارات هي القاعدة، والتعاون عن بُعد مُرحَّب به. خُدِم عملاء في الإمارات وماليزيا وسنغافورة، تشمل بيئات تأمين وطيران منظَّمة لا يُسمَح فيها بأن تفلت التفاصيل.',
      ],
    },
    {
      id: 'working',
      title: 'أين يكون التوافق أقوى',
      paragraphs: [
        'يُنتَج أقوى عمل في المهام التي تتطلب عمق الخادم الخلفي وحِسّ منتج الذكاء الاصطناعي معاً — وكلاء ببوابات أدوات حقيقية، وأنظمة RAG تُقيَّم لا تُفترَض، وواجهات تبقى سريعة تحت الحِمل، والحُكم على التمييز بين عرض توضيحي وشيء سيصمد.',
        'إذا طابق أيٌّ من ذلك ما يُبنى، أو كان دور أو منصة يستحق النقاش، فصفحة التواصل هي أسرع طريقة للوصول.',
      ],
    },
  ],
}
...
const home: Site['home'] = {
  ...
  alsoFeatured: {
    kicker: 'أعمال مميّزة أخرى',
    title: 'الاسترجاع والبحث ومنصة البحث العلمي',
    description:
      'الأنظمة التي حوّلت نماذج الذكاء الاصطناعي الأولية إلى خدمات إنتاجية قابلة للقياس — إضافةً إلى Factory6G، حيث يُدرَس سؤال الموثوقية نفسه على الجانب البحثي.',
  },
  capabilities: {
...
const pageHero: Site['pageHero'] = {
  ...
  experience: {
    ...
    title: 'الخبرة',
    description:
      'خمسة أدوار، الأحدث أولاً — من أول وظيفة خادم خلفي إلى إدارة محفظة ذكاء اصطناعي للتأمين. التعليم مذكور بشكل منفصل.',
  },
  education: {
    kicker: 'الخلفية',
    title: 'التعليم',
...
const researchToolkit: ResearchToolkit = {
  title: 'أدوات البحث',
  description:
    'تُستخدَم في مسار الدكتوراه، لا في التسليم اليومي. التفاصيل الكاملة في صفحة البحث.',
  items: [
    'خطوط محاكاة Python',
    'TensorFlow / Sionna',
    'YOLOv8 / رؤية حاسوبية',
...
const ui: Ui = {
  ...
  skillsStats: {
    domains: (n) => `${n} مجالات`,
    domainsDetail: 'مجمَّعة حسب كيفية ظهورها في الإنتاج',
    tools: (n) => `${n} أداة ومنصة`,
    toolsDetail: 'عبر الخوادم والذكاء الاصطناعي والبيانات والـ full stack',
    expert: (n) => `${n} بمستوى خبير`,
    expertDetail: 'الأدوات التي تُطلَب أولاً',
    years: '+6 سنوات',
    yearsDetail: 'كلها مُطبَّقة في الإنتاج',
  },
