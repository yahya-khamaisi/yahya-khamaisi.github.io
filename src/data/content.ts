...
export const projects: Project[] = [
  ...
  },
  {
    ...
    href: 'https://github.com/yahya-khamaisi/factory-6g',
    mock: 'factory6g',
    tier: 'featured',
    category: 'research',
  },
  ...
  },
  {
    slug: 'filterkit',
    title: 'FilterKit',
    tag: 'GitHub · React + Tailwind',
    role: 'Independent developer',
    period: '2024',
    blurb:
      'A fast, filterable product catalog with search, sorting, and skeleton loading states.',
    overview:
      'FilterKit is a small React + TypeScript catalog UI built to explore fast client-side filtering — search, category filters, sort order, live result counts, and skeleton loading states, styled with Tailwind CSS.',
    details: [
      'Search, category filtering, and sort order over a product catalog.',
      'Skeleton loading state and empty-result handling.',
      'Tailwind CSS layout with responsive product cards.',
    ],
    impact: [
      'A reusable filtering pattern published as a clean reference implementation.',
    ],
    stack: ['React', 'TypeScript', 'Tailwind CSS', 'Vite'],
    href: 'https://github.com/yahya-khamaisi/filterkit',
    mock: 'dashboard',
    tier: 'more',
    category: 'github',
  },
  {
    slug: 'next-starter-kit',
    title: 'Next Starter Kit',
    tag: 'GitHub · Next.js Template',
    role: 'Independent developer',
    period: '2024',
    blurb:
      'An opinionated personal starter template on Next.js 16, React 19, TypeScript, and Tailwind CSS 4.',
    overview:
      'A clean baseline for new projects — modern Next.js App Router conventions, Tailwind CSS 4, and TypeScript wired up from the start so new work can skip the boilerplate.',
    details: [
      'Next.js 16 App Router with React 19 and TypeScript.',
      'Tailwind CSS 4 and a flat ESLint config out of the box.',
      'A branded landing page in place of the default create-next-app scaffold.',
    ],
    impact: [
      'A reusable starting point for new personal and client projects.',
    ],
  ...
  },
  {
    slug: 'polar-6g-sim',
    title: 'Polar 6G Sim',
    tag: 'GitHub · 6G Simulation',
    role: 'Independent developer',
    period: '2024',
    blurb:
      'A polar-coded 6G link simulation across AWGN, IRS, THz, IAB, URLLC, Massive MIMO, and NOMA channel models.',
    overview:
      'A standalone simulation exploring polar-coding performance across multiple 6G channel models — network slicing, resource allocation, mobility, and BER evaluation, independent of the doctoral research platform.',
    details: [
      'Eight channel models compared under a shared polar-coding pipeline.',
      'Network slicing, resource allocation, and mobility effects layered on transmission.',
      'BER vs. SNR sweeps reported as tables and plots via a CLI.',
    ],
    impact: [
      'A public, runnable reference for comparing 6G channel models side by side.',
    ],
    stack: ['Python', 'NumPy', 'Polar codes', 'Matplotlib'],
    href: 'https://github.com/yahya-khamaisi/polar-6g-sim',
    mock: 'factory6g',
    tier: 'more',
    category: 'github',
  },
  ...
  },
  {
    slug: 'skycast',
    title: 'SkyCast',
    tag: 'GitHub · Azure Functions',
    role: 'Independent developer',
    period: '2020',
    blurb:
      'A tiny weather API on Azure Functions backed by OpenWeatherMap, plus a static frontend.',
    overview:
      'SkyCast pairs a serverless Azure Functions API with a small static frontend — fetching and presenting live forecast data through a clean client UI, built to practice consuming third-party APIs without hardcoding secrets into source control.',
    details: [
      'Azure Functions (Node.js) backed by the OpenWeatherMap API.',
      'API key read from environment configuration, never committed.',
      'A static frontend calling the function endpoint directly.',
    ],
    impact: ['A complete, working serverless API integration shipped end-to-end.'],
    stack: ['Azure Functions', 'Node.js', 'OpenWeatherMap API'],
    href: 'https://github.com/yahya-khamaisi/skycast',
    mock: 'weather',
    tier: 'more',
    category: 'github',
  },
...
export const publications: Publication[] = [
  {
    ...
    icon: 'chip' as const,
    note: 'A YOLOv8-based detection approach applied to CCTV footage analysis.',
  },
  {
    title:
